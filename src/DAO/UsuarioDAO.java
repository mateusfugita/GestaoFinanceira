...
public class UsuarioDAO extends PadraoDAO {
    ...
    @Override
    public CallableStatement criarParametros(Connection connection, PadraoVO o) throws SQLException {
        CallableStatement stmt = connection.prepareCall(nomeProcedureInsert());
